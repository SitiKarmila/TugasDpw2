        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{url('contaxt')}}">Contact Us</a>
              </li>
              <li class="nav-item">
          ...
          <div class="">
            <div class="product_owl-carousel owl-carousel">
              <div class="item">
                <div class="box ">
                  <div class="img-box">
                    <img src="{{url('public')}}/images/i1.png" alt="" />
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="box ">
                  <div class="img-box">
                    <img src="{{url('public')}}/images/i2.png" alt="" />
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="box ">
                  <div class="img-box">
                    <img src="{{url('public')}}/images/i3.png" alt="" />
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="box ">
                  <div class="img-box">
                    <img src="{{url('public')}}/images/i4.png" class="pl-4" alt="" />
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="box ">
                  <div class="img-box">
                    <img src="{{url('public')}}/images/i5.png" class="pl-2" alt="" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="img-box pl-md-3">
            <img src="{{url('public')}}/images/about-img3.png" class="box_img" alt="about img">
          </div>
        </div>
      </div>
    </div>
